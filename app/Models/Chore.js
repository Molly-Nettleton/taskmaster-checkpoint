...
export class Chore {
  ...
  /**
   * @param {{chorename: string, choreComplete: string, id:string, cardId:string, color: string,}} data 
   */
  constructor(data) {
  ...
  get ChoreTemplate() {
    ...
    <div class="d-flex justify-content-between align-items-baseline">
                ...
                <p class="p-2 mb-2 border-bottom border-2 border-secondary">${this.chorename}</p>
